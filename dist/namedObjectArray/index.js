...
exports.namedObjectArray = void 0;
...
var zodArrayOfLength = function (_a) {
    ...
    return function (zods) {
        return (0, fp_1.flow)((0, fp_1.flow)(function (value) { return value; }, (0, fp_1.map)(addKeyToZod), types_1.zodDiscriminatedUnion, zod_1.z.array, function (zod) { return (!min ? zod : zod.min(min)); }, function (zod) { return (!max ? zod : zod.max(max)); }, function (zod) { return (length === undefined ? zod : zod.length(length)); }), function (zod) {
            return zod;
        })(zods);
    };
};
var namedObjectArray = function (_a) {
...
exports.namedObjectArray = namedObjectArray;
