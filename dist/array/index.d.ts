...
import { z } from "zod";
import type { InferParsedValue, InferResolvedValue, InferValue, NamedSchemaFields, Rule, SanityType, SanityTypeDef, TupleOfLength } from "../types";
...
declare type ItemDefinitions = Omit<Schema.ArrayDefinition["of"][number], NamedSchemaFields>;
export declare const array: <ItemValue, ParsedItemValue, ResolvedItemValue, ItemsArray extends [SanityType<ItemDefinitions, ItemValue, ParsedItemValue, ResolvedItemValue>, ...SanityType<ItemDefinitions, ItemValue, ParsedItemValue, ResolvedItemValue>[]], Length extends number, Min extends number, Max extends number, Value extends TupleOfLength<AddKey<InferValue<ItemsArray[number]>>, Precedence<Length, Min>, Precedence<Length, Max>, []>, ParsedValue = TupleOfLength<AddKey<InferParsedValue<ItemsArray[number]>>, Precedence<Length, Min>, Precedence<Length, Max>, []>, ResolvedValue = TupleOfLength<AddKey<InferResolvedValue<ItemsArray[number]>>, Precedence<Length, Min>, Precedence<Length, Max>, []>>({ length, max, min, validation, of: items, mock, zod: zodFn, zodResolved, ...def }: {
